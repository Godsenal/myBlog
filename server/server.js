...
app.use('/postImages', express.static(path.resolve(__dirname + './../public/assets/posts/images')));
app.use('/postThumbnails', express.static(path.resolve(__dirname + './../public/assets/posts/thumbnails')));
app.use('/', express.static(path.resolve(__dirname, './../public'))); // 정적인 페이지 로드
